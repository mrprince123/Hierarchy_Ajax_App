...
<body class="bg-slate-100">
    <div class="border border-1 bg-white rounded-xl p-4 w-1/4 mt-10 m-auto">
        ...
        <h1 class="font-bold text-xl text-teal-500 text-center mb-2">Employee Login Here</h1>
        ...
        <form class="flex flex-col mb-5" action="{{ route('employee.processLogin') }}" method="post">
            @csrf
        ...
        <a href="{{ route('employee.register') }}" class="mt-4 font-semibold text-center">Register New Employee</a>
    </div>
